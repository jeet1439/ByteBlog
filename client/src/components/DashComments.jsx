     ...
     {currentUser.isAdmin && comments.length > 0 ? (
      ...
      <Table hoverable className="shadow-md">
        <Table.Head>
              ...
              <Table.HeadCell className="w-36">comment content</Table.HeadCell>
              <Table.HeadCell className="w-64">Number of likes</Table.HeadCell>
              <Table.HeadCell className="w-20">PostId</Table.HeadCell>
              <Table.HeadCell className="w-20">UserId</Table.HeadCell>
